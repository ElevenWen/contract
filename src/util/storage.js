...
*
***/
export const saveToLocal = function saveToLocal(_navigatorName_, id, key, value) {
...
***/
export const loadFromLocal = function loadFromLocal(_navigatorName_, id, key, def) {
  let navigatorName = window.localStorage[_navigatorName_];
  if (!navigatorName) {
    return def;
  }
...
export const removeLocal = function removeLocal(_navigatorName_) {
  let navigatorName = window.localStorage[_navigatorName_];
  if (navigatorName) {
